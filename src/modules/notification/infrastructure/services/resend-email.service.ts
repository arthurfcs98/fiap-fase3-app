...
export class ResendEmailService implements IEmailService {
  ...
  constructor(private readonly configService: ConfigService) {
    ...
    this.fromEmail = this.configService.get<string>('EMAIL_FROM', 'oficina@asdevit.com');
  ...
  async sendStatusChangeEmail(
    ...
    this.logger.log(`Email sent via Resend to ${notification.customerEmail} for order ${notification.orderNumber}`);
  }
