...
import { ApproveQuoteUseCase } from "@/modules/service-order/application/use-cases/approve-quote/approve-quote.use-case";
...
describe("ApproveQuoteUseCase", () => {
  ...
  beforeEach(async () => {
    ...
    useCase = module.get<ApproveQuoteUseCase>(ApproveQuoteUseCase);
    jest.clearAllMocks();
  });
  ...
  describe("execute", () => {
    it("should approve quote and transition to AWAITING_START", async () => {
